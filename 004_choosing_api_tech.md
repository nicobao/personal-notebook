...
The reason is:
- the tooling is great for an api-first approach to designing APIs. One unique statically typed source of truth which is the OpenAPI/AsyncAPI documents or the .proto files - and then everything compiles from it: documentation and client/server code in any languages you like
